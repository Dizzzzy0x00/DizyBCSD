...
class GraphEncoderGIN(nn.Module):
    def __init__(self, input_dim, hidden_dim1, hidden_dim2, output_dim):
        ...
        # 定义多个GCN层
        self.conv1 = GCNConv(input_dim, hidden_dim1)  # (139, 256)
...
# 三元组训练函数
def train(model, loader, optimizer, loss_fn, device, epoch, save_dir="./model/TripletGNN", 
...
if __name__ == "__main__":
    ...
    save_path = "./model/SiameseGCN"  # 模型保存路径
